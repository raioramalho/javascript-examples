/*
  ...
  - You are about to drop the column `carrinho_id` on the `Pedido` table. All the data in the column will be lost.
...
CREATE TABLE "new_Carrinho" (
    ...
    "produto_id" INTEGER,
    "quantidade" INTEGER,
    CONSTRAINT "Carrinho_pedido_id_fkey" FOREIGN KEY ("pedido_id") REFERENCES "Pedido" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
